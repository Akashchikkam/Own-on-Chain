...
function DistributorDashboard() {
  ...
  const handleScanSuccess = async (result) => {
    ...
    try {
      ...
      if (batchMode) {
        // Try to extract tokenId from error or result if available
        // If not available, we'll just clear all (safe fallback)
              ...
              >
                ...
                <div className="action-buttons" style={{ marginTop: '1rem' }}>
                  <button
                    ...
                    disabled={transferLoading === product.tokenId || loading}
                  >
